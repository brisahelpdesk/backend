export interface ProductModule {
   ...
   */
  setActive(productId: string, active: boolean): Promise<{
    id: string;
    active: boolean;
    updatedAt: Date;
  }>;
   ...
   */
  associateToContract(productId: string, contractId: string): Promise<{
    productId: string;
    contractId: string;
    createdAt: Date;
  }>;
   ...
   * @throws {DuplicateAssociationException} If association already exists
   */
  associateToUser(productId: string, userId: string): Promise<{
    productId: string;
    userId: string;
    createdAt: Date;
  }>;
